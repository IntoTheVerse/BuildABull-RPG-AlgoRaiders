...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    [HideInInspector] public int currentDungeonLevelListIndex = 0;
    ...
    private void HandleGameState()
    {
        ...
        switch (gameState)
        {
            case GameState.gameStarted:
                ...
                // Play first level
                currentDungeonLevelListIndex = (int)WalletManager.instance.playerLevel;
